    ...
    <>
      <div className="flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="flex flex-col">
            ...
            <select
              id="type"
              value={updatedListing.general.type}
              name="general.type"
          ...
          <div className="flex flex-col">
            ...
            <div className="relative flex">
              <input
                type="number"
                id="price"
                value={updatedListing.general.price}
                name="general.price"
              ...
              <div className="absolute right-2 top-1/2 transform -translate-y-1/2 text-slate-600 flex items-center gap-1">
                <FaEuroSign />
                {updatedListing.general.type === "rent" && (
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="flex flex-col">
            ...
            <select
              id="constructionType"
              value={updatedListing.general.constructionType}
          ...
          <div className="flex flex-col">
            ...
            <div className="relative flex">
              <input
                type="number"
                id="surfaceArea"
                value={updatedListing.general.surfaceArea}
          ...
          <div className="flex flex-col">
            ...
            <input
              type="number"
              id="constructionYear"
              value={updatedListing.general.constructionYear}
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col">
          <textarea
            id="description"
            value={updatedListing.general.description}
