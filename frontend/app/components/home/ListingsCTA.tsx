...
export default function ListingsCTA() {
  return (
    <section className="bg-gray-200 w-full h-auto flex flex-col lg:flex-row py-10 justify-evenly gap-10 px-20">
      <div
        className="bg-white rounded-2xl flex flex-col p-5 gap-4 py-10 shadow-xl ring-1
       ring-slate-300 ring-offset-8 w-full lg:w-1/3 items-center justify-center"
      >
        <Image
        ...
        <Link href="/listings?type=buy" className="self-center mt-4">
          <button
           ...
           px-5 py-3 rounded-full text-base md:text-lg lg:text-2xl shadow-md shadow-slate-400 transition-colors"
          >
            Browse homes
          </button>
        </Link>
      ...
      <div
        className="bg-white rounded-2xl flex flex-col p-5 gap-4 py-10 shadow-xl ring-1 ring-slate-300
       ring-offset-8 w-full lg:w-1/3 items-center justify-center"
      >
        <Image
