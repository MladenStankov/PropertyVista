  ...
  useEffect(() => {
    async function fetchListings() {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/auth/profile-favourite-listings`,
        { credentials: "include" }
      );
                ...
                {listings.length > 0 ? (
                  listings.map((listing) => (
                    <div key={listing.uuid}>
                      <ProfileFavouriteListing
                        listing={listing}
                        handleUnfavourite={confirmDelete}
                      />
                    </div>
                  ))
                ) : (
                  ...
                  >
                    ...
                    <p className="text-gray-500 text-center max-w-sm">
                      Start exploring properties and save your favorites to see
                      them here
                    </p>
                  </motion.div>
                )}
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Are you sure you want to remove this listing from your
                favourites?
              </p>
